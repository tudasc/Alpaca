...
namespace matcher{
    ...
    vector<vector<unsigned int>> levenshteinDistance(const vector<string>& s1, const vector<string>& s2){
     ...
     */
    vector<string> paramsToFlatString(vector<pair<string, pair<string, string>>> param){
        vector<string> output;
    ...
    vector<Operation> getOptimalParamConversion(vector<pair<string, pair<string, string>>> oldParamStructure, vector<pair<string, pair<string, string>>> newParamStructure){
        ...
        vector<vector<unsigned int>> levenshteinMatrix = levenshteinDistance(oldParams, newParams);
